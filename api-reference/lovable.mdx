...
**Design:** Rime design language — near-black background (#0D0D0D, #161616), 
orange-to-red gradient accents (#FF9300 → #B10000), grey surfaces (#333, #1A1A1A), 
...
2. Voice picker — grid of 8 Arcana flagship voice cards (luna, astra, sirius, 
   estelle, lyra, vespera, walnut, eliphas) with gradient avatars
3. "Generate Voiceover" button
4. Audio controls — play/pause, progress bar, download wav

**Right Panel:**
5. Three.js particle sphere — A small orb of 500+ particles, centered in the 
