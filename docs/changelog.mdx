...
* **Arcana will be sunset on August 15, 2026.**
  ...
  * We recommend migrating before August 15 so you can test voices and validate output on your own timeline. Questions? Join the [Rime help desk Slack](https://join.slack.com/t/rimehelpdesk/shared_invite/zt-1s49vizx3-s9FcTTCONbmuj~BudhcsfQ) or email [support@rime.ai](mailto:support@rime.ai).
</Update>
