...
description: "Build real-time voice experiences with Rime—from your first text-to-speech request to production streaming, voice agents, and private deployments."
mode: custom
---

<div className="mx-auto max-w-5xl px-6 py-16 lg:py-24">
  <div className="mx-auto max-w-3xl text-center">
    <p className="text-sm font-semibold uppercase tracking-wider text-orange-700 dark:text-orange-400">
      Rime documentation
    </p>
