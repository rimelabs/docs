...
|---|---|---|---|---|
| **`/ws3`** (JSON) | [Coda](/api-reference/coda/websockets-json) | [Arcana](/api-reference/arcana/websockets-json) | [Mist v3](/api-reference/mistv3/websockets-json) | Not supported |
| **`/ws2`** (JSON) | Not supported | Not supported | Not supported | [Mist v2](/api-reference/mistv2/websockets-json) |
