...
description: "Force letter-by-letter pronunciation of codes, IDs, and acronyms using the spell() function for naturalistic pauses within the sequence."
icon: 'font'
---
...
<audio controls src="/sounds/docs/jonathan.mp3"></audio>
