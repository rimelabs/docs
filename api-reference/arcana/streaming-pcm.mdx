...
<ParamField body="samplingRate" type="int" default="24000">
  The sampling rate (Hz). Accepted values: 8000, 16000, 22000, 24000, 44000, 48000, 96000. Anything above 24000 is up sampling.
</ParamField>
...
const options = {
  ...
  body: '{"speaker":"<string>","text":"<string>","modelId":"arcana","repetition_penalty":1.5,"temperature":0.5,"top_p":0.5,"samplingRate":24000,"max_tokens":1200}'
};
