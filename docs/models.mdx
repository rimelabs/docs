---
title: Models
description: "Compare Rime's TTS models for real-time voice agents: Coda (flagship quality), Arcana (multilingual code-switching), Mist v3 (fastest TTFA), and Mist v2 (pronunciation control)."
icon: cube
---
