...
Rime's TTS is unique among next-gen TTS offerings in allowing users to customize their output. Out-of-the-box, Rime's voices will speak fluently and correctly, but since strings of words can be pronounced differently for special effect, we allow users to add custom pauses and custom pronunciations. Let's see how.
