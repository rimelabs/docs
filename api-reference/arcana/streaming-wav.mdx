...
Streaming WAV returns a stream of bytes with the RIFF WAVE header followed by the samples in 16-bit little-endian linear PCM.
...
sf.write("audio_output.wav", audio_samples, 24000)
```
