...
You are affected if any request, config file, or environment variable in any environment sets `modelId` to one of these three values:

| Identifier | Notes |
| :--- | :--- |
| `arcana` | Routes English to the v2 engine and other languages to v3, so behavior can differ by language |
| `arcanav2` | |
| `arcanav3` | |
