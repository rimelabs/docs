...
The JSON WebSocket endpoint will be served at port 8001.  For example, `ws://localhost:8001`, which will be equivalent to our [cloud websockets-json API](/api-reference/endpoint/websockets-json).
