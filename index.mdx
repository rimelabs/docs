...
description: "Start with one request, then choose the Rime path for streaming speech, voice agents, integrations, or private deployment."
mode: custom
---
...
<div className="mx-auto max-w-5xl px-6 py-16 lg:py-24">
  <div className="mx-auto max-w-3xl text-center">
    ...
    <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-zinc-600 dark:text-zinc-400">
      Ship natural speech with one API. Start with a request you can run now, then move into streaming, voice agents, or private deployment without changing platforms.
    </p>
    ...
    <p className="mt-4 text-sm text-zinc-500 dark:text-zinc-500">
      Create an API token in the <a className="font-medium text-[#B2321A] underline decoration-[#B2321A]/60 underline-offset-4 hover:text-[#8f2815] dark:text-[#E68732] dark:decoration-[#E68732]/60 dark:hover:text-[#f0a35c]" href="https://app.rime.ai/tokens">Rime dashboard</a>.
    </p>
  </div>
  ...
  <div className="mt-16">
    ...
    <p className="mt-4 text-sm text-zinc-500 dark:text-zinc-500">
      The <a className="font-medium text-[#B2321A] underline decoration-[#B2321A]/60 underline-offset-4 hover:text-[#8f2815] dark:text-[#E68732] dark:decoration-[#E68732]/60 dark:hover:text-[#f0a35c]" href="/docs/quickstart-five-minute">five-minute tutorial</a> adds voice selection, audio formats, and streaming. The <a className="font-medium text-[#B2321A] underline decoration-[#B2321A]/60 underline-offset-4 hover:text-[#8f2815] dark:text-[#E68732] dark:decoration-[#E68732]/60 dark:hover:text-[#f0a35c]" href="/docs/quickstart-cli">Rime CLI</a> runs the same workflow from your terminal.
    </p>
  </div>

  <div className="mt-20">
    <p className="text-sm font-semibold uppercase tracking-wider text-[#B2321A] dark:text-[#E68732]">Choose by architecture</p>
    <h2 className="mt-2 text-3xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50">Start with the path that fits your application</h2>
    <p className="mt-3 max-w-3xl text-zinc-600 dark:text-zinc-400">
      Use HTTP for request-and-response synthesis, WebSockets for live conversation, or a framework tutorial when transport and orchestration should come pre-wired.
    </p>
  ...
  <div className="mt-20">
    <p className="text-sm font-semibold uppercase tracking-wider text-[#B2321A] dark:text-[#E68732]">Production path</p>
    ...
    <p className="mt-3 max-w-3xl text-zinc-600 dark:text-zinc-400">
      Authentication and voice choice come first. Streaming behavior, production controls, and private deployment follow.
    </p>
  ...
  <div className="mt-20">
    ...
    <p className="mt-3 max-w-3xl text-zinc-600 dark:text-zinc-400">
      Start with Coda for most new applications and Arcana migrations. Choose Mist v3 when the lowest time to first audio matters most. Keep Arcana for multilingual code-switching or language coverage that Coda does not yet provide.
    </p>
  ...
  <div className="mt-20 border-t border-zinc-200 pt-12 dark:border-zinc-800">
    <p className="text-sm font-semibold uppercase tracking-wider text-[#B2321A] dark:text-[#E68732]">Reference and tools</p>
    <h2 className="mt-2 text-3xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50">Details for production work</h2>
    <p className="mt-3 max-w-3xl text-zinc-600 dark:text-zinc-400">
      Use the API reference for field-level contracts, the cheat sheet for runnable examples, the CLI for quick tests, and MCP for conversational prototyping.
    </p>
