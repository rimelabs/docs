...
Rime is committed to protecting the security and privacy of our users' data. We have implemented a comprehensive security framework to ensure the safety of our users' information. Email us at [support@rime.ai](mailto:support@rime.ai) to request a compliance report.
