...
The [Rime CLI](/docs/quickstart-cli) wraps this same endpoint behind a `rime tts` command if you'd rather not write the request yourself. Or connect Claude or your IDE directly to Rime through the [hosted MCP server](/docs/mcp).
