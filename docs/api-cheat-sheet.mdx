...
description: "Base URLs, bearer authentication, and runnable examples for Rime's HTTP, WebSocket, voice, vocabulary, and text-normalization endpoints."
icon: list-check
---

Use this page for Rime's service hosts, authentication pattern, and runnable requests across the main API surfaces. Create a key on the [API Tokens page](https://app.rime.ai/tokens) before running authenticated examples.
