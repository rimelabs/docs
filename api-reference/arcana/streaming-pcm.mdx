...
<ParamField body="sampling_rate" type="int" default="24000">
  The sampling rate (Hz). Range is 8000 to 48000.
</ParamField>
...
const options = {
  ...
  body: '{"speaker":"<string>","text":"<string>","modelId":"arcana","repetition_penalty":1.5,"temperature":0.5,"top_p":0.5,"sampling_rate":24000,"max_tokens":1200}'
};
