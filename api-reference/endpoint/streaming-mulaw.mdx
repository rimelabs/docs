...
<ParamField body="pauseBetweenBrackets" type="bool" default="false">
  ...
  Example: "Hello \<200> World" adds a 200ms pause between "Hello" and "World"
</ParamField>

<ParamField body="phonemizeBetweenBrackets" type="bool" default="false">
  When set to true, you can specify the phonemes for a word enclosed in angle brackets. <br/>
  Example: "Hello \<\<phoneme ph='HH AH0 L OW1'>> World" will pronounce "Hello" as "HH AH0 L OW1"
</ParamField>
...
const options = {
  ...
  body: '{"speaker":"<string>","text":"<string>","modelId":"<string>", "speedAlpha":1.0,"reduceLatency":false}'
};
