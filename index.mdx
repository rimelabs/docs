    ...
    <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <div className="rounded-2xl border border-zinc-200 p-6 dark:border-zinc-800">
        ...
        <div className="mt-4 flex flex-col gap-2.5 text-sm">
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/quickstart-five-minute">Generate your first audio</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="https://app.rime.ai/tokens">Create an API token</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/api-authentication">Authenticate requests</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/voices">Choose a voice</a>
        </div>
      </div>
      <div className="rounded-2xl border border-zinc-200 p-6 dark:border-zinc-800">
        <div className="flex items-center gap-2.5">
        ...
        <div className="mt-4 flex flex-col gap-2.5 text-sm">
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/streaming">Stream audio over HTTP</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/websockets">Use WebSockets</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/quickstart-livekit">Build with LiveKit</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/pipecat">Integrate with Pipecat</a>
        </div>
      </div>
      <div className="rounded-2xl border border-zinc-200 p-6 dark:border-zinc-800">
        <div className="flex items-center gap-2.5">
        ...
        <div className="mt-4 flex flex-col gap-2.5 text-sm">
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/models">Choose a model</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/prompting">Guide delivery with prompts</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/platform/pronunciation-control">Control pronunciation</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/text-normalization">Format text</a>
        </div>
      </div>
      <div className="rounded-2xl border border-zinc-200 p-6 dark:border-zinc-800">
        <div className="flex items-center gap-2.5">
        ...
        <div className="mt-4 flex flex-col gap-2.5 text-sm">
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/latency">Reduce latency</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/regional-endpoints">Select a region</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/on-prem/quickstart">Deploy on-prem</a>
          <a className="text-zinc-600 no-underline transition-colors hover:text-[#B2321A] dark:text-zinc-400 dark:hover:text-[#E68732]" href="/docs/privacy-compliance">Review privacy and compliance</a>
        </div>
      </div>
    </div>
  </div>
