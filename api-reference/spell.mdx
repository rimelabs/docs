...
This holds for any number, letter, or alphanumeric string. It will be spelled out in full if included in the parentheses of `spell()`. Let’s see how this works:
...
|  Audio Clip  |
|--------------|
|  <audio controls src="https://rime.ai/sounds/blog/jonathan.mp3"></audio>
