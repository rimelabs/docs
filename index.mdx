...
<div className="mx-auto max-w-5xl px-6 py-16 lg:py-24">
  ...
  <div className="mt-20">
    ...
    <p className="mt-3 max-w-3xl text-zinc-600 dark:text-zinc-400">
      Start with Coda for the strongest voice quality and multilingual coverage. Choose Mist v3 when the lowest possible latency matters more. Arcana remains available for existing deployments, but new work should target Coda.
    </p>
