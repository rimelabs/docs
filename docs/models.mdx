...
## Additional controls (Coda and Arcana)

<Note>The controls in this section apply to Coda and Arcana. Mist v3 and Mist v2 do not expose `temperature`, `top_p`, or `repetition_penalty`.</Note>

Coda and Arcana support several additional controls due to their LLM backbones. We recommend leaving these on the default values.
...
See the [API reference](/docs/api-reference) for endpoint-specific details.
