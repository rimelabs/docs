...
<ParamField body="saveOovs" type="bool" default="false">
  If set to `true`, Rime shall save any currently OOV (out-of-vocabulary) words encounterd in `text`, and save them for the User or Team to review on the
  <a href="https://app.rime.ai/oov/">Speech QA dashboard</a>
</ParamField>
