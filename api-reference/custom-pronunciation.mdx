...
|    Audio Clip     |      Sentence             |
|-----------------|--------------------------|
|   <audio controls src="/audio/gorbulets.wav"></audio>     |    actually, `{g1orby0ul2Ets}` is a word i just made up.      |
...
The Coverage tool is available in the Rime dashboard: [rime.ai/dashboard/coverage](https://rime.ai/dashboard/coverage). You can also check coverage [via the API](/api-reference/endpoint/oov).
