...
<Warning>**Check your voices before you plan anything else.** Coda's lineup was selected rather than carried over wholesale: 56 of Arcana's 64 featured voices are served by Coda, against 6 of the other 202. If you use a featured voice you will most likely find it by name. If you use one from further down Arcana's catalog, you are choosing a replacement, which needs listening and sign-off rather than a config edit. Start with [step 2](#step-2-check-every-voice-you-use).</Warning>
