...
For uncommon words, such as unique brand names or product names, Rime's speech synthesis model may not pronounce them correctly out of the box. While the Rime team can add new words to the dictionary within about 24 hours, if you want to specify the pronunciation yourself, you can input a custom pronunciation string within curly brackets.
...
The Coverage tool is available in the Rime dashboard: [rime.ai/dashboard/coverage](https://rime.ai/dashboard/coverage). 
...
![coverage tool](https://drive.google.com/file/d/10S4YzaIbklJJBa5DIanMnj3ljVhXrUcI/view?usp=sharing)

## Get Pronunciation

The Pronunciation tool is available in the Rime dashboard: [rime.ai/dashboard/pronunciation](https://rime.ai/dashboard/pronunciation).
...
![pronunciation tool inputs](https://drive.google.com/file/d/1JdRUdbrpqfw1yBFUKin0V--_cfn4gdu5/view?usp=drive_link)
...
![pronunciation tool outputs](https://drive.google.com/file/d/1Dl_jDa90kasL4zdU_YWdlkzKzeaIAnzz/view?usp=sharing)
