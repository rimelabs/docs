...
<Columns cols={2}>
  ...
  <Card title="Migrate off Arcana" icon="arrow-right-arrow-left" href="/docs/migrate-arcana-to-coda">
    Arcana retires August 15, 2026. The request shape does not change, but Coda's voice lineup was selected rather than ported, so check whether your voice is on it.
  </Card>
