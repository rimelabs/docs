...
| Punctuation and prosody | `,`, `.`, `?`, `...` | [Punctuation](/docs/punctuation) |
...
1. **Submit the word to Rime** to add to the dictionary (typically about a week — [contact us](mailto:support@rime.ai) if you need faster turnaround or have an SLA). The fastest way is the [Speech QA dashboard](/platform/speech-qa), which surfaces out-of-vocabulary words from your traffic and lets you approve or correct them in one place. You can also reach the team directly at [support@rime.ai](mailto:support@rime.ai) or via your shared Slack channel.
