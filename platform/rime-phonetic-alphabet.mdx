...
You don't have to compose phonetic strings symbol by symbol. Post a recording of the word to the [Phonemize API](/api-reference/other/phonemize) and it returns a transcription in this alphabet, stress markers included:
