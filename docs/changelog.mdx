...
* Arcana release `20260122`:
  * `rime.engine.initial_latency` and `rime.engine.generated_audio_duration` have saner defaults and [can be tuned](https://docs.rime.ai/api-reference/on-prem/metrics).
  * Added `spell()` support.
  * General performance improvements and bug fixes.
</Update>
...
* Added [Lovable integration guide](/api-reference/lovable) with template for building voice-enabled apps.
* Added [Replit integration guide](/api-reference/replit) with template for building voice-enabled apps.
</Update>
...
* Arcana release `20251206`:
  * [OpenTelemetry metrics](https://docs.rime.ai/api-reference/on-prem/metrics#metrics-arcana) are now available in the model images.
