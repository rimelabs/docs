...
- Sinhala `lang=sin` or `lang=si` (Arcana only)
- Spanish `lang=spa` or `lang=es`
- Tamil `lang=tam` or `lang=ta` (Arcana only)
...
Your [dashboard](https://app.rime.ai/) is a great place to find a voice. By specifying filters, you can find Rime voices that meet your needs.
