...
| :--- | :--- | :--- | :--- | :--- |
| Entire response | Coda, Arcana, Mist v3 | `timeScaleFactor` | Below 1.0 | Above 1.0 |
| Entire response, compatibility | Coda, Arcana, Mist v3 | `speedAlpha` | Above 1.0 | Below 1.0 |
