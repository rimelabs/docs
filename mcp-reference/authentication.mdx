...
If a key-gated tool is called without a key, it responds with a pointer to [sign up](https://app.rime.ai/signup/) rather than an error. A keyless connection is still useful for exploring the catalog and generating integration code.
