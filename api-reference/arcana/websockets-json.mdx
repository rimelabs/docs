---
title: 'Arcana WebSockets JSON (deprecated)'
description: "Deprecated Arcana JSON WebSocket reference. Arcana is retired on August 15, 2026 at 12:00 UTC; migrate cloud integrations to Coda."
