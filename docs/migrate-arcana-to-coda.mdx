...
description: "Arcana retires August 15, 2026 at 12:00 UTC. The request shape does not change; your voice, its language, and its sound do."
icon: "arrow-right-arrow-left"
---

import CompareTwoVoices from "/snippets/compare-two-voices.mdx";

Arcana retires August 15, 2026 at 12:00 UTC. Traffic sent with `modelId: arcana`, `arcanav2`, or `arcanav3` needs to move to [Coda](/docs/models#coda) before then.
