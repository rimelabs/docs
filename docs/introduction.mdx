---
title: Introduction
description: "Rime's text-to-speech API for real-time voice agents and IVR: low-latency streaming TTS with Coda, Arcana, and Mist models across English, Spanish, French, Portuguese, German, Japanese, and Hebrew."
icon: book
---
