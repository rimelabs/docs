...
## Finding a mist voice

The list of active mist voices is as follows:

```
[juan, victor, ana, yadira, mark, jared, patricia, joe, rosco, melanie, 
steve, wayne, ned, linda, joy, rodney, tanya, antoine, 
madison, misty, maya, elena, josh, jake, elliot, tj, stan, janice, amber]
```

Using the dashboard to find a mist voice and generate speech will be available next week!
