...
|    Audio Clip     |      Sentence             |
|-----------------|--------------------------|
|   <audio controls src="/audio/wait_no_pause.wav"></audio>     |    wait, are you actually serious.      |
|   <audio controls src="/audio/wait_750.wav"></audio>    |      wait. `<750>` are you actually serious.        |
