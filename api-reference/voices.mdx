...
You can view a list of all voices [online](https://users.rime.ai/data/voices/all-v2.json) or [via the API](/api-reference/data/voices).

Similarly you can view all the voice details [online](https://users.rime.ai/data/voices/voice_details.json) or [via the API](/api-reference/data/voice-details).
