...
For brand or product names on Mist v3, Coda, or Arcana, request a dictionary addition or respell the word in plain English, accepting that respelling is approximate.
