...
English and Hindi shrink, so plan for a narrower shortlist there. No Hindi voice name carries over: Arcana serves `anaya`, `anil`, and `arya`, while Coda serves `nadi` and `taru`. If you synthesize Hebrew, get in touch before the date so someone can work through the options with you.
