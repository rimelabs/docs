...
<Columns cols={2}>
  ...
  <Card title="Migrate off Arcana" icon="arrow-right-arrow-left" href="/docs/migrate-arcana-to-coda">
    Arcana retires August 15, 2026. The request shape does not change, but 204 of its 266 voices have no Coda counterpart, so most migrations need a voice change.
  </Card>
...
<Columns cols={2}>
  ...
  <Card title="Choose voices, models, and languages" icon="microphone-lines" href="/docs/voices">
    Browse every voice on [Coda](/docs/voices-coda) and [Mist v3](/docs/voices-mist-v3), grouped by language, and check [which voices survive a model change](/docs/voices-availability).
  </Card>
