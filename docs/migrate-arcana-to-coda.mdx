...
Your speaker may not exist. Only 62 of Arcana's 266 voice names are also served by Coda, and the other 204 are not available under any `modelId`, so keeping the name is often not an option.
