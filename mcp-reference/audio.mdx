...
Hosts that support MCP Apps (such as Claude) render an audio player directly in the conversation. The MP3 travels outside the model's context, so playback is free of token overhead. This is the default experience and requires no configuration.
