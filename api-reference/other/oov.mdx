...
We can add new words to our dictionary as needed in about a week — [contact us](mailto:support@rime.ai) if you need faster turnaround or have an SLA. Or you can immediately [generate a custom pronunciation](/docs/custom-pronunciation), which uses the [Rime phonetic alphabet](/docs/custom-pronunciation#the-rime-phonetic-alphabet).
