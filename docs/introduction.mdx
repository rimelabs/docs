...
<div className="mx-auto max-w-5xl px-6 py-16 lg:py-24">
  <div className="mx-auto max-w-3xl text-center">
    ...
    <p className="mt-4 text-sm text-zinc-500 dark:text-zinc-500">
      Need a key? <a href="https://app.rime.ai/tokens">Create an API token</a> in the Rime dashboard.
    </p>
  </div>
  ...
  <div className="mt-16">
    ...
    <p className="mt-4 text-sm text-zinc-500 dark:text-zinc-500">
      Want the complete walkthrough? Follow <a href="/docs/quickstart-five-minute">TTS in five minutes</a>. Prefer the terminal? Try the <a href="/docs/quickstart-cli">Rime CLI</a>.
    </p>
  </div>
