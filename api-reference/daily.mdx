...
Explore our [Rime Pipecat demo agents](https://github.com/rimelabs/rime-pipecat-agents) for starter code to build voice agents, with examples for both English and multilingual responses. For more details on the Pipecat framework, visit [Pipecat's documentation](https://docs.pipecat.ai/getting-started/introduction).