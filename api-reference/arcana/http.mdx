---
title: 'Arcana streaming HTTP (deprecated)'
description: "Deprecated Arcana HTTP reference. Arcana is retired on August 15, 2026 at 12:00 UTC; migrate cloud integrations to Coda."
...
<ParamField body="speaker" type="string" required>
  Must be a voice available on arcana. See the <a href="/docs/voices">voice catalog</a>.
</ParamField>
