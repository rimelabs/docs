---
title: Models
description: "Coda and Mist are Rime's models: what each one is for, which features they support, and how to choose between them."
icon: cube
---
...
<Note>**Arcana is deprecated and will be sunset on August 15, 2026 at 12:00 UTC.** If you use it, see the [Arcana sunset notice](/docs/arcana-sunset) for what changes and [Migrate from Arcana to Coda](/docs/migrate-arcana-to-coda) for the cutover.</Note>
...
All production models are available through the cloud API and on-premises, and all stream audio over [HTTP and WebSockets](/docs/streaming).
...
| Attribute | Coda | Mist |
| :---- | :----: | :----: |
| Number of voices | 184 | 78 (v3), 138 (v2) |
| Multilingual | ✅ | ✅ |
