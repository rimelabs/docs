...
| `modelId` | `coda` (flagship), `arcana`, `mistv3`, `mistv2` | Set it explicitly — WebSocket endpoints default to `mistv2`. |
| `text` | string | Up to 500 characters per request via the API. |
