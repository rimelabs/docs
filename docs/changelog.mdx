...
* **Arcana will be sunset on August 15, 2026.**
  ...
  * We recommend migrating before August 15 so you can test voices and validate output on your own timeline. Questions? Reach out to your account manager via Slack or email, or contact [support@rime.ai](mailto:support@rime.ai).
</Update>
